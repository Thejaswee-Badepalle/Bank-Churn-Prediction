...
model = pickle.load(open('svc_model1.pkl','rb'))
...
def main():
    ...
    placeholder_features = [0] * (59 - 10)  # Placeholder values for the missing features
    
    #prediction code
    if st.button('Predict'):
        features = np.array([[Feature1, Feature2, Feature3, Feature4, Feature5,Feature6,Feature7,Feature8,Feature9,Feature10]+ placeholder_features])
